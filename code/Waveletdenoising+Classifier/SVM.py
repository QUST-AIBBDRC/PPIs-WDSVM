...
data_train = sio.loadmat('H.mat')
data=data_train.get('H')
row=data.shape[0]
column=data.shape[1]
...
yscore_sum.to_csv('H_yscore_sum_SVC.csv')
ytest=ytest[np.array(range(1,row)),:]
ytest_sum = pd.DataFrame(data=ytest)
ytest_sum.to_csv('H_ytest_sum_SVC.csv')
...
data_csv.to_csv('H_Matine_SVC_result.csv')
